...
text = 'Former President Barack Obama will speak to young people at the University of Chicago on Monday. Returning to the city for that will be his first public event since leaving the White House.'
#Tokenization
...
new_trigrams = []
c = 0
while c < len(wtokens) - 1:
    new_trigrams.append((wtokens[c], wtokens[c+1]))
    c += 1
